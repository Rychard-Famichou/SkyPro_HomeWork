...
- загрузка файлов типа: json, csv, excel
...
---
### 1. Запрос открытия файла

Выполняет модуль `readers`

### 2. Запрос фильтрации по статусу

Выполняет модуль `processing`

### 3. Запрос сортировки по дате

Выполняет модуль `processing`

### 4. Запрос сортировки по валюте

Выполняет модуль `generators` (Требуется обновление)

### 5. Запрос фильтрации по строке в описании

Выполняет модуль `regex` (Требуется обновление)
...
Состояние тестирования от 07.03.2026:
+ покрытие 94%
