...
def dict_list_processing():
    return [{'id': 414288290, 'state': 'EXECUTED', 'date': '2019-07-03T18:35:29.512364'},
...
def dict_list_no_key():
    return [{'id': 414288290, 'date': '2019-07-03T18:35:29.512364'},
...
def dict_list_no_date():
    return [{'id': 414288290, 'state': 'EXECUTED'},
...
@pytest.fixture
def dict_list_state():
    return [{'id': 414288290, 'state': 'Finished', 'date': '2019-07-03T18:35:29.512364'},
            {'id': 939719570, 'state': 'executed', 'date': '2018-06-30T02:08:58.425572'},
            {'id': 594226727, 'state': 'CANCELED', 'date': '2018-09-12T21:27:25.241689'},
...
@pytest.fixture
def dict_list_date():
    return [{'id': 414288290, 'state': 'EXECUTED', 'date': ' '},
