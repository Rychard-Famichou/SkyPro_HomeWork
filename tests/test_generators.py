...
def test_transaction_descriptions(generators_dict_list):
    expected = ["Перевод организации", "Перевод со счета на счет", "Перевод со счета на счет", "Перевод с карты на карту", "Перевод организации"]
    assert list(generators.transaction_descriptions(generators_dict_list)) == expected


# Тест правильных данных
def test_card_number_generator():
    expected = ["0000 0000 0000 9995", "0000 0000 0000 9996", "0000 0000 0000 9997", "0000 0000 0000 9998", "0000 0000 0000 9999"]
...
def test_pl_filter(generators_dict_list):
    ...
    assert next(pl_transactions) == "Транзакции в заданной валюте отсутствуют"
