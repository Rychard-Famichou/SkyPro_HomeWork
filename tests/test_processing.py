...
def test_filter_by_state(dict_list_processing):
    assert processing.filter_by_state(dict_list_processing) == [{'date': '2019-07-03T18:35:29.512364', 'id': 414288290, 'state': 'EXECUTED'},
...
def test_sort_by_date(dict_list_processing):
    assert processing.sort_by_date(dict_list_processing) == [{'date': '2019-07-03T18:35:29.512364', 'id': 414288290, 'state': 'EXECUTED'},
...
def test_no_key_sort(dict_list_no_key):
    assert processing.sort_by_date(dict_list_no_key) == [{'date': '2019-07-03T18:35:29.512364', 'id': 414288290},
...
def test_no_date_filter(dict_list_no_date):
    assert processing.filter_by_state(dict_list_no_date) == [{'id': 414288290, 'state': 'EXECUTED'},
