...
'''
Тест форматирования даты: 5 варианта
'''
@pytest.mark.parametrize("string_date, expected_result", [
    ("2024-03-11T02:26:18.671407", "11.03.2024"), # Верная дата
    ("2024-13-11T02:26:18.671407", "Ошибка: Неверный формат даты. Ожидается ГГГГ-ММ-ДД..."), # 13 месяц
    ("2024-03-41T02:26:18.671407", "Ошибка: Неверный формат даты. Ожидается ГГГГ-ММ-ДД..."), # 41 день
    ("0000-00-00T02:26:18.671407", "Ошибка: Неверный формат даты. Ожидается ГГГГ-ММ-ДД..."), # Нули
    ("20240311T02:26:18.671407", "Ошибка: Неверный формат даты. Ожидается ГГГГ-ММ-ДД...") # Без тире
])
